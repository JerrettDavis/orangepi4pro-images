...
grep -q 'sunxi_drm fbcycle' /boot/boot.cmd || fail 'boot.cmd does not support bounded framebuffer cycle visual test'
...
grep -q 'uboot-visual-fbcycle-ok' /boot/boot.cmd || fail 'boot.cmd lacks fbcycle success marker'
